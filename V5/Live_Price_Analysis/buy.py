...
def add_order_entry(id, symbol, timestamp):
    file_path = r'C:\Users\David\Documents\ProfitPilot\V5\Live_Price_Analysis\buy_orders.json'
...
def buy(symbol,list_number):
    centers_json_path_list = r'C:\Users\David\Documents\ProfitPilot\V5\XY\centers.json'
    ...
    buy_button_coordonatesX = buy_button_coordonates[0]
